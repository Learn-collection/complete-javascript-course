...
// calcDisplaySum mary(account1.movements);
...
// const juliaDatas = [3, 5, 2, 12, 7];
// const kateData = [4, 1, 15, 8, 3];

// const juliaDoges = juliaDatas.slice(1, 3);
...
// const ranArr = Array.from({ length: 100 }, (_, i) =>
...
// }, movements[0]);
// console.log(max);
// const dogeAgeArr = [3, 34, 11, 1, 4, 98, 2, 44, 6];
// const calcAverageHumanAge = function (dogeAges) {
//   const humanAge = dogeAges
//   .map(age => age <=2 ? 2 * age : (16 + age) * 2)
//   .filter(hAge => hAge > 18)
//   const avg = humanAge.reduce((acc, mov) => acc + mov, 0) / humanAge.length;

//   console.log(avg);
// };

// calcAverageHumanAge(dogeAgeArr);
